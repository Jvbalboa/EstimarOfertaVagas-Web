...
public class JsfLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {  private static final Log logger = LogFactory.getLog(JsfLoginUrlAuthenticationEntryPoint.class);
