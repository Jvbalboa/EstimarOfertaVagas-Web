...
import br.ufjf.coordenacao.sistemagestaocurso.model.estrutura.AlunoSituacao;
import br.ufjf.coordenacao.sistemagestaocurso.model.estrutura.DisciplinaReprovada;
...
public class GraficosDisciplinasReprovadasController implements Serializable {
	...
	public void onRowSelect(SelectEvent event) {
		...
		chartModelAluno = new GChartModelBuilder().setChartType(getChartTypeAluno())
				.addColumns("Situação", "Quantidade")
