...
import model.arvore.CurriculumFactory;
	...
	public void importarDisciplinas(Grade grade,boolean consideraCo){
		...
		for(GradeDisciplina gradeDisciplina : listaGradeDisciplina){
			...
			if (gradeDisciplina.getTipoDisciplina().equals("Obrigatoria") ){
				...
				Class c = ClassFactory.getClass(grade.getCurso().getCodigo(),grade.getCodigo(),_class,gradeDisciplina.getDisciplina().getCargaHoraria().toString());
				...
				for (PreRequisito prerequisito:listaPreRequisito){
					...
					Class pre = ClassFactory.getClass(grade.getCurso().getCodigo(),grade.getCodigo(),prerequisite,prerequisito.getDisciplina().getCargaHoraria().toString());
				...
				Class c = ClassFactory.getClass(grade.getCurso().getCodigo(),grade.getCodigo(),gradeDisciplina.getDisciplina().getCodigo(),gradeDisciplina.getDisciplina().getCargaHoraria().toString());
		...
		for(Equivalencia equivalencia : listaEquivalencia){
			...
			c = ClassFactory.getClass(grade.getCurso().getCodigo(),grade.getCodigo(), idDaGrade,equivalencia.getDisciplinaGrade().getCargaHoraria().toString());
			ClassFactory.getClass(grade.getCurso().getCodigo(),grade.getCodigo(), idNaoDaGrade,equivalencia.getDisciplinaGrade().getCargaHoraria().toString());
